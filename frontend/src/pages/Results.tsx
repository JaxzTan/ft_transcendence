...
const PLACE_COLORS = ['#ffd66b', '#b8a9d4', '#ff6b8a', '#665f80']
    ...
    return (
      <div style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: '#0f0a1a', color: '#f8f0ff' }}>
        <div style={{ ...card, padding: 36, textAlign: 'center' }}>
          ...
          <div style={{ color: '#b8a9d4', marginBottom: 20 }}>Play a game first to see results here.</div>
  ...
  return (
    <div
      style={{
        ...
        background: 'radial-gradient(100% 100% at 50% 10%, rgba(167,139,250,0.18) 0%, rgba(244,114,182,0.22) 45%, #0f0a1a 100%)',
      }}
    >
      <div
        style={{
          width: '100%', maxWidth: 580, borderRadius: 28, padding: '42px 38px', textAlign: 'center',
          background: 'linear-gradient(145deg, rgba(40,28,65,0.94), rgba(25,18,42,0.98))',
          border: '1px solid rgba(167,139,250,0.3)',
          boxShadow: '0 40px 90px -25px rgba(0,0,0,.85), 0 0 40px rgba(167,139,250,.2)',
          backdropFilter: 'blur(20px)',
        }}
      >
        <div style={{ fontFamily: "'Space Grotesk', 'Outfit', sans-serif", fontSize: 13, letterSpacing: '.34em', color: '#a78bfa', fontWeight: 800, textTransform: 'uppercase' }}>
        ...
        <div style={{ color: '#d4c8e8', fontSize: 16, fontWeight: 500 }}>
        ...
        <div
          style={{
            ...
            display: 'grid', placeItems: 'center', fontSize: 38, fontWeight: 900, color: '#0f0a1a',
        ...
        <div style={{ fontWeight: 800, fontSize: 18, color: '#f8f0ff', marginBottom: 20, fontFamily: "'Space Grotesk', 'Outfit', sans-serif" }}>
          {winnerName}
        </div>
          ...
          {ranked.map((p, i) => (
            <div
              ...
              style={{
                ...
                background: i === 0 ? 'linear-gradient(135deg, rgba(167,139,250,0.18), rgba(244,114,182,0.22))' : 'rgba(255,255,255,0.04)',
                border: '1px solid ' + (i === 0 ? 'rgba(167,139,250,0.6)' : 'rgba(255,255,255,0.08)'),
                boxShadow: i === 0 ? '0 0 20px rgba(167,139,250,0.3)' : 'none',
              }}
            >
              <div
                style={{
                  width: 28, height: 28, borderRadius: 8, display: 'grid', placeItems: 'center',
                  fontWeight: 900, fontSize: 13, color: '#0f0a1a', background: PLACE_COLORS[i],
                  fontFamily: "'Space Grotesk', 'Outfit', sans-serif",
                }}
              >
                {i + 1}
              ...
              <div style={{ flex: 1, textAlign: 'left', fontWeight: 700, fontSize: 14.5, color: '#f8f0ff', fontFamily: "'Space Grotesk', 'Outfit', sans-serif" }}>
                {p.color === myColor ? t('common.you') : p.username}
              </div>
              <div style={{ color: '#b8a9d4', fontSize: 13, fontWeight: 600 }}>
        ...
        {rematchError && (
          <div style={{ color: '#ff6b8a', fontSize: 13, marginBottom: 12, background: 'rgba(255,107,138,0.15)', padding: '8px 12px', borderRadius: 8 }}>{rematchError}</div>
        )}
