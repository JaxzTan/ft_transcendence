        ...
        <div className="app-wrapper">
          ...
          <header className="hero-section" style={{ padding: '16px 0 14px' }}>
            <h1 className="hero-title" style={{ fontSize: '1.45rem', marginBottom: 4 }}>
              GLOBAL RANKINGS // LADDER
            </h1>
            <p className="hero-subtitle" style={{ fontSize: '0.75rem', marginBottom: 0 }}>
              CYBER ARENA COMBATANTS • SORTED BY ELO RATING
            </p>
          </header>

          {/* Leaderboard Table Container */}
          <section className="retro-window" style={{ maxWidth: 1100, margin: '0 auto', width: '100%' }}>
            <div className="window-header">
              <span>🏆 CYBER LADDER // ACTIVE COMBATANTS</span>
            ...
            <div className="window-body" style={{ display: 'flex', flexDirection: 'column', gap: 14, padding: 14 }}>
              {/* Category Tabs */}
              ...
              >
                ...
                <div
                  style={{
                    display: 'grid',
                    gridTemplateColumns: '175px 1.5fr 110px 110px 90px',
                    gap: 10,
                    padding: '10px 16px',
