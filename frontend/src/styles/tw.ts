...
export const RETRO_AUTH_TITLE =
	"font-['Orbitron',sans-serif] font-black tracking-[2.5px] text-[2.75rem] leading-[1.1] bg-[linear-gradient(135deg,#00f0ff_0%,#ff007f_50%,#9d00ff_100%)] bg-clip-text text-transparent"
...
export const RETRO_AUTH_LABEL =
	"font-['Orbitron',sans-serif] text-[0.82rem] font-bold tracking-[1.5px] text-[rgba(0,240,255,.75)] uppercase"

export const RETRO_AUTH_INPUT =
	"w-full [border:1.5px_solid_rgba(0,240,255,.28)] rounded-none py-[40px] px-5 [font:500_18.5px_'Share_Tech_Mono',monospace] text-white bg-[rgba(0,0,0,.45)] outline-none [transition:all_0.2s_ease] box-border placeholder:text-[rgba(184,166,228,.35)] focus:border-[#00f0ff] focus:shadow-[0_0_18px_rgba(0,240,255,.35),inset_0_0_8px_rgba(0,240,255,.1)] focus:bg-[rgba(0,0,0,.6)]"

export const RETRO_AUTH_BTN =
	"border-0 rounded-xl py-[40px] px-6 [font:900_18px_'Orbitron',sans-serif] tracking-[1.8px] text-white cursor-pointer bg-[linear-gradient(135deg,#ff007f,#9d00ff)] shadow-[0_0_22px_rgba(255,0,127,.4),0_8px_26px_rgba(157,0,255,.35)] [transition:all_0.22s_ease] uppercase hover:-translate-y-px hover:shadow-[0_0_32px_rgba(255,0,127,.65),0_12px_34px_rgba(157,0,255,.45),0_0_65px_rgba(0,240,255,.2)] active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed disabled:translate-y-0"

export const RETRO_AUTH_BTN_OUTLINE =
	"[border:1.5px_solid_rgba(0,240,255,.3)] rounded-[11px] py-[75px] px-[18px] [font:700_16px_'Share_Tech_Mono',monospace] text-[rgba(255,255,255,.88)] cursor-pointer bg-[rgba(0,240,255,.06)] [transition:all_0.2s_ease] flex items-center justify-center gap-2.5 hover:border-[#00f0ff] hover:bg-[rgba(0,240,255,.15)] hover:shadow-[0_0_16px_rgba(0,240,255,.3)] hover:text-white"
